...
{
  line_2d(renderer, x1, y1, x2, y2);
  line_2d(renderer, x2, y2, x3, y3);
  line_2d(renderer, x3, y3, x1, y1);
}
...
void triangle_3d(SDL_Renderer *renderer, Camera cam, Vector3 p1, Vector3 p2, Vector3 p3)
{
  ...
  line_2d(renderer, screen_p1.x, screen_p1.y, screen_p2.x, screen_p2.y);
  line_2d(renderer, screen_p2.x, screen_p2.y, screen_p3.x, screen_p3.y);
  line_2d(renderer, screen_p3.x, screen_p3.y, screen_p1.x, screen_p1.y);
